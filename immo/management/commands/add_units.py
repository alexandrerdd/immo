...
from immo.models import Bien, Unit, Tenant
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        units_data = {
            ...
            'Bd Maurice Lemonnier 64': ['Rez commercial', 'étage 1, Chambre avant sud', 'étage 1, Chambre avant nord', 'étage 1, Chambre arrière', 'étage 2, Chambre avant sud', 'étage 2, Chambre avant nord', 'étage 2, Chambre arrière', 'étage 3, Chambre avant sud', 'étage 3, Chambre avant nord', 'étage 3, Chambre arrière'],
            'Bd Maurice Lemonnier 60': ['rez commercial', 'étage 1', 'étage 2', 'étage 3', 'étage 4, chambre avant', 'étage 4, chambre arrière'],
            'Bd Maurice Lemonnier 54': ['rez commercial', 'étage 0,5', 'étage 1', 'étage 1,5', 'étage 2, chambre avant', 'étage 2, chambre arrière', 'étage 3, chambre avant', 'étage 3, chambre arrière', 'étage 4, chambre avant', 'étage 4, chambre arrière'],
        }
